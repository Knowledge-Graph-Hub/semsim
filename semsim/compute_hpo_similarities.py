...
def compute_hpo_similarities(resnik_path: str, ancestors_jaccard_path: str):
    ...
    compute_pairwise_ancestors_jaccard(dag=hpo, path=ancestors_jaccard_path)

    compute_pairwise_resnik(
        dag=hpo, counts=counts, path=ancestors_jaccard_path
    )
